...
class Task {
	...
	public static function get_all($data_bus) {
	...
	public static function create($insert_data, $data_bus) {
	...
	public static function update($update_data, $data_bus) {
	...
	public static function remove($id, $data_bus) {
	...
	public static function update_status($update_data, $data_bus) {
	...
	public static function update_order($task_by_priority, $data_bus) {
